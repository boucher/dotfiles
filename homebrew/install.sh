...
brew cask install --force charles adium air-video-server dropbox google-drive subethaedit colloquy google-chrome steam sublime-text transmit transmission mumble firefox racket hexfiend spotify
